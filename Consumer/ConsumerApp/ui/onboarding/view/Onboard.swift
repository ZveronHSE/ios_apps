...
public protocol OnboardDataSource: AnyObject {
    ...
    func swiftyOnboardViewForBackground(_ swiftyOnboard: Onboard) -> UIView?
...
public extension OnboardDataSource {
...
public protocol OnboardDelegate: AnyObject {
    
    func swiftyOnboard(_ swiftyOnboard: Onboard, currentPage index: Int)
    func swiftyOnboard(_ swiftyOnboard: Onboard, leftEdge position: Double)
    func swiftyOnboard(_ swiftyOnboard: Onboard, tapped index: Int)
}

public extension OnboardDelegate {
...
public class Onboard: UIView, UIScrollViewDelegate {
    
    open weak var dataSource: OnboardDataSource? {
        didSet {
    ...
    open weak var delegate: OnboardDelegate?
    ...
    fileprivate var overlay: OnboardOverlay?
    fileprivate var pages = [OnboardPage]()
